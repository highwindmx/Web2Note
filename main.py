...
from modules.db import DataBaseJson, TBIndex, NotePack
...
class App(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        # 载入数据库
        self.DB_path = "E:/test/Index"
        self.database = DataBaseJson()
        self.database.create(self.DB_path)
        # 载入数据表
        self.note_root_dir = "E:/test"
        ...
        self.note_cur_dir = "E:/notetemp"
        # print(self.note_index.data)       
        # 构建窗体
