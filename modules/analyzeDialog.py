...
class Analysis(QDialog):
    ...
    def initIF(self):
        ...
        self.info0_LB = QLabel(self)
        self.info0_LB.setText("当前笔记库更新时间：{}".format(self.main_Win.note_index.getUpdateTime().strftime("%Y-%m-%d_%H:%M:%S")))
        self.info1_LB = QLabel(self)
        self.info1_LB.setText("笔记加载文件夹：{}".format(self.main_Win.note_cur_dir))
        self.info2_LB = QLabel(self)
        self.info2_LB.setText("笔记索引文件夹：{}".format(self.main_Win.note_index_dir))
        self.info3_LB = QLabel(self)
        self.info3_LB.setText("笔记库根文件夹：{}".format(self.main_Win.note_root_dir))
        ...
        self.info4_LB.setPixmap(QPixmap("./style/wordcould.png"))
        # self.info4_LB.setPixmap(QPixmap.fromImage(wordcloud.to_image()))
        self.layout.addWidget(self.info0_LB, 0,0, 1,1)  
        self.layout.addWidget(self.info1_LB, 1,0, 1,1)
        self.layout.addWidget(self.info2_LB, 2,0, 1,1)
        self.layout.addWidget(self.info3_LB, 3,0, 1,1)
        self.layout.addWidget(self.info4_LB, 4,0, 1,1)
